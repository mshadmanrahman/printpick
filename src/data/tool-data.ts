...
export const UPGRADE_PATHS: Record<string, readonly UpgradePath[]> = {
  ...
  "bambu-lab-a1-combo":      [{ slug: "bambu-lab-p2s", reason: "Enclosed for ABS/ASA + quick-swap nozzle" }, { slug: "bambu-lab-p1s", reason: "Enclosed for ABS/ASA + HEPA filter" }],
  "bambu-lab-p1s":           [{ slug: "bambu-lab-p2s", reason: "Quick-swap nozzle + AMS 2 Pro drying" }, { slug: "bambu-lab-h2d", reason: "Dual nozzles + larger build volume" }],
  "bambu-lab-p2s":           [{ slug: "bambu-lab-h2d", reason: "Dual nozzles + 325mm build volume" }, { slug: "prusa-core-one", reason: "Open-source + legendary support" }],
  ...
  "qidi-x-plus-3":           [{ slug: "qidi-x-max-3", reason: "Larger build volume (325mm)" }, { slug: "bambu-lab-h2d", reason: "Dual nozzles + best-in-class software" }],
